...
def get_script(dataset, unlearning_model, attack, seed, cf=1.0, df_size=0.5):
    ...
    if attack == 'label_strong':
        return f"python main.py --df_size 0.5 --dataset {dataset} --unlearning_model {unlearning_model} --attack_type label_strong --random_seed {seed} --gnn gcn  --data_dir /scratch/akshit.sinha/data {cf_str}"
