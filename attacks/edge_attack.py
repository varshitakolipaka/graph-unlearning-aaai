...
def edge_attack_specific_nodes(data, epsilon, seed, class1=None, class2=None):
    ...
    print(f"DEBUG: Attacking edges between class {class1} and class {class2}")
    ...
    print(f"DEBUG: Number of nodes in class {class1}: {len(class1_indices)}")
    print(f"DEBUG: Number of nodes in class {class2}: {len(class2_indices)}")
    ...
    print(f"DEBUG: Number of edges to add: {epsilon}")
    ...
    print(f"DEBUG: Number of edges actually added: {len(poisoned_edges)}")
    print(f"DEBUG: Number of nodes affected: {len(poisoned_nodes)}")
    ...
    print(f"DEBUG: Original number of edges: {data.edge_index.shape[1]}")
    augmented_edge = torch.cat([data.edge_index.to(device), edge_index_to_add], dim=1)
    data.edge_index = augmented_edge
    print(f"DEBUG: New number of edges: {data.edge_index.shape[1]}")
