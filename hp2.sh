...
# python run_hp_tune.py --dataset Cora --df_size 0.5 --random_seed 0 --data_dir /scratch/akshit.sinha/data --attack_type label --db_name label_main --gnn gcn --gnndelete --megu

python eval_script.py --dataset Cora --attack_type label --df_size 0.5 --start_seed 0 --end_seed 5 --gnndelete --megu --db_name label_main
