...
def parse_args():
    ...
    parser.add_argument('--weight_decay', type=float, default=0.005191475570177285, help='weight decay')
    ...
    parser.add_argument('--contrastive_margin', type=float, default=500.0, help="margin for the contrastive loss")
