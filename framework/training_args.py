...
def parse_args():
    ...
    parser.add_argument('--attack_type', type=str, default='label', help='attack type', choices=["label", "edge"])
    parser.add_argument('--unlearning_model', type=str, default='gnndelete', help='unlearning method')
