...
def parse_args():
    ...
    parser.add_argument('--attack_type', type=str, default='edge', help='attack type', choices=["label", "edge", "random", "trigger"])
    ...
    parser.add_argument('--unlearn_lr', type=float, default=0.05, help='unlearn learning rate')
